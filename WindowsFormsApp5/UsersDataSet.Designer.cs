...
namespace WindowsFormsApp5 {
    ...
    public partial class UsersDataSet : global::System.Data.DataSet {
        ...
        public partial class tbl_UsersDataTable : global::System.Data.TypedTableBase<tbl_UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public tbl_UsersRow Addtbl_UsersRow(string Username, string Password, string Name, string Email) {
...
namespace WindowsFormsApp5.UsersDataSetTableAdapters {
    ...
    public partial class tbl_UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[tbl_Users] WHERE (([UserID] = @Original_UserID) AND ([Username" +
                "] = @Original_Username) AND ([Password] = @Original_Password) AND ([Name] = @Ori" +
                "ginal_Name) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original" +
                "_Email)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[tbl_Users] ([UserID], [Username], [Password], [Name], [Email])" +
                " VALUES (@UserID, @Username, @Password, @Name, @Email);\r\nSELECT UserID, Username" +
                ", Password, Name, Email FROM tbl_Users WHERE (UserID = @UserID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[tbl_Users] SET [UserID] = @UserID, [Username] = @Username, [Password] = @Password, [Name] = @Name, [Email] = @Email WHERE (([UserID] = @Original_UserID) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ([Name] = @Original_Name) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT UserID, Username, Password, Name, Email FROM tbl_Users WHERE (UserID = @UserID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp5.Properties.Settings.Default.UsersConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserID, Username, Password, Name, Email FROM dbo.tbl_Users";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT UserID, Username, Password, Name, Email FROM dbo.tbl_Users WHERE Username " +
                "= @Username";
            ...
            this._commandCollection[2].CommandText = "SELECT UserID, Username, Password, Name, Email FROM dbo.tbl_Users WHERE Username " +
            ...
            this._commandCollection[3].CommandText = "INSERT INTO [dbo].[tbl_Users] ([Username], [Password], [Name], [Email]) VALUES (@" +
            ...
            this._commandCollection[3].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Email", global::System.Data.SqlDbType.NVarChar, 120, global::System.Data.ParameterDirection.Input, 0, 0, "Email", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(UsersDataSet.tbl_UsersDataTable dataTable) {
        ...
        public virtual UsersDataSet.tbl_UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            UsersDataSet.tbl_UsersDataTable dataTable = new UsersDataSet.tbl_UsersDataTable();
        ...
        public virtual int FillBy(UsersDataSet.tbl_UsersDataTable dataTable, string Username) {
        ...
        public virtual UsersDataSet.tbl_UsersDataTable GetDataBy1(string Username) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByLogin(UsersDataSet.tbl_UsersDataTable dataTable, string Username, string Password) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual UsersDataSet.tbl_UsersDataTable GetDataBy(string Username, string Password) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(UsersDataSet.tbl_UsersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_UserID, string Original_Username, string Original_Password, string Original_Name, string Original_Email) {
        ...
        public virtual int Insert(int UserID, string Username, string Password, string Name, string Email) {
        ...
        public virtual int Update(int UserID, string Username, string Password, string Name, string Email, int Original_UserID, string Original_Username, string Original_Password, string Original_Name, string Original_Email) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Username, string Password, string Name, string Email, int Original_UserID, string Original_Username, string Original_Password, string Original_Name, string Original_Email) {
            return this.Update(Original_UserID, Username, Password, Name, Email, Original_UserID, Original_Username, Original_Password, Original_Name, Original_Email);
        }
        ...
        public virtual int InsertQuery(string Username, string Password, string Name, string Email) {
